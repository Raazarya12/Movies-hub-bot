...
BOT_TOKEN = environ.get('BOT_TOKEN', "8115914824:AAHXhvcygnv4f7viUl24WRaZXyuIsQzwDkE")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8199400850').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002663725977').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002825704281'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002754501360'))  # Bin channel id (make sure bot is admin)
Latest_movies_freeOnNet = int(environ.get('Latest_movies_freeOnNet', '-1001430858047'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002425109560'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002769861382')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002067624859')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001430858047').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001430858047').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.postimg.cc/xjpckMRS/IMG-20250125-213310-944.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'moviesrajkumar@fam')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://monsterrise99:oIgNirG5XP7nA27B@cluster0.bevuwul.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'monsterrise')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002340645127'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/+d4WxbLQWmcs2MTNl')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+d4WxbLQWmcs2MTNl')  # Tutorial video link for opening shortlink website
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Monster_Rise')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('Latest_movies_freeOnNet', 'https://t.me/Latest_movies_freeOnNet')
OWNERID = int(os.environ.get('OWNERID', '8199400850'))  # Replace with the actual admin ID
